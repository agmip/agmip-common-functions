...
//        dailyData = WeatherFunctions.getDailyData(data);
...
//        try {
//            k = divide(log("0.02") + "", subtract(rd, pp), finalScale + 1);
//            som2_0 = multiply("0.95", subtract("1", som3_0));
//        } catch (Exception e) {
...
//            som3_fac = subtract("1", divide(max("0.02", f), "0.95", finalScale + 1));
